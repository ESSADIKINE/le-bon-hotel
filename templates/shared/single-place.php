            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'lbhotel-single-article ' . $category_class ); ?>>
                <div class="lbhotel-single-page">
                    ...
                    <div class="lbhotel-single-content">
                        <div class="lbhotel-single-content__inner">
                            <div class="lbhotel-single-description">
                                <?php the_content(); ?>
                            </div>
                            <div class="lbhotel-single-details">
                                <?php if ( ! empty( $highlights ) ) : ?>
                                    <section class="lbhotel-detail-section">
                                        <h2 class="lbhotel-detail-section__title"><?php esc_html_e( 'Highlights', 'lbhotel' ); ?></h2>
                                        <ul class="lbhotel-detail-section__list">
                                            <?php foreach ( $highlights as $highlight ) : ?>
                                                <li class="lbhotel-detail-section__item">
                                                    <?php if ( $highlight['label'] ) : ?>
                                                        <span class="lbhotel-detail-section__label"><?php echo esc_html( $highlight['label'] ); ?>:</span>
                                                    <?php endif; ?>
                                                    <span class="lbhotel-detail-section__value">
                                                        <?php
                                                        if ( ! empty( $highlight['multiline'] ) ) {
                                ...
                                <?php if ( ! empty( $details ) ) : ?>
                                    <section class="lbhotel-detail-section">
                                        <h2 class="lbhotel-detail-section__title"><?php esc_html_e( 'Key details', 'lbhotel' ); ?></h2>
                                        <dl class="lbhotel-detail-section__definitions">
                                            <?php foreach ( $details as $detail ) : ?>
                                                <div class="lbhotel-detail-section__definition">
                                                    <dt class="lbhotel-detail-section__label"><?php echo esc_html( $detail['label'] ); ?></dt>
                                                    <dd class="lbhotel-detail-section__value">
                                                        <?php
                                ...
                                <?php if ( ! empty( $location_parts ) ) : ?>
                                    <section class="lbhotel-detail-section">
                                        <h2 class="lbhotel-detail-section__title"><?php esc_html_e( 'Location details', 'lbhotel' ); ?></h2>
                                        <ul class="lbhotel-detail-section__list">
                                            <?php foreach ( $location_parts as $part ) : ?>
                                                <li class="lbhotel-detail-section__item"><?php echo esc_html( $part ); ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                        <?php if ( $map_url ) : ?>
                                            <p class="lbhotel-detail-section__action">
                                                <a class="lbhotel-button lbhotel-button--map" href="<?php echo esc_url( $map_url ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Open in Google Maps', 'lbhotel' ); ?></a>
                                            </p>
                                        <?php endif; ?>
                                    </section>
                                <?php endif; ?>
                                ...
                                <?php if ( $contact_phone ) : ?>
                                    <section class="lbhotel-detail-section">
                                        <h2 class="lbhotel-detail-section__title"><?php esc_html_e( 'Contact', 'lbhotel' ); ?></h2>
                                        <p class="lbhotel-detail-section__value"><?php echo esc_html( $contact_phone ); ?></p>
                                    </section>
                                <?php endif; ?>
                            </div>
                        </div>
