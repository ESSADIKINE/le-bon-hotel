...
(function () {
    ...
    const normaliseHotel = (hotel) => {
        ...
        return {
            ...
            name: hotel.title || hotel.name || 'Listing',
            city: hotel.city || '',
            price: hotel.price || '',
